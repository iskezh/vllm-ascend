...
* \brief Kernel entry and tiling-key dispatch for VllmFusedInferAttentionScore.
*/

#include "kernel_operator.h"
#include "adv_api/matmul/matmul_intf.h"
#include "fused_infer_attention_score_tiling_key.h"
#include "fused_infer_attention_score_kernel.h"
