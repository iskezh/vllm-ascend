...
/*!
* \file fused_infer_attention_score_kernel.h
* \brief
*/
#ifndef FUSED_INFER_ATTENTION_SCORE_KERNEL_H
#define FUSED_INFER_ATTENTION_SCORE_KERNEL_H

#include "fused_infer_attention_score_common.h"
