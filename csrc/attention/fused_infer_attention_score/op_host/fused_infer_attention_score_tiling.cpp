...
REGISTER_TILING_DATA_CLASS(VllmFusedInferAttentionScore_5100000000010200100, FAInferTilingData)
REGISTER_TILING_DATA_CLASS(VllmFusedInferAttentionScore_5100000000010200103, FAInferTilingData)
REGISTER_TILING_DATA_CLASS(VllmFusedInferAttentionScore_5100000000010200200, FAInferTilingData)
REGISTER_TILING_DATA_CLASS(VllmFusedInferAttentionScore_5100000000010200203, FAInferTilingData)
                                                      ...
                                                      uint32_t aicoreNum)
{
    ...
    const bool *sparseStatsFlagPtr = attrs->GetAttrPointer<bool>(FIA_SPARSE_STATS_FLAG_ATTR_INDEX);
    ...
    if (hostSeqAvail && pagedCacheFlag && maxQSeqlen == 1 && minQSeqlen == 1 &&
        ...
        (minKvSeqlen >= fdMinKv) &&
        GetBoolAttrOrDefault(context, FIA_FLASH_DECODE_ATTR_INDEX, true)) {
