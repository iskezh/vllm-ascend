...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.def(
        "npu_fused_infer_attention_score_out(Tensor query, Tensor key, Tensor value,"
    ...
    ops.def(
        "npu_fused_infer_attention_score_get_workspace(Tensor query, Tensor key, Tensor value,"
        "                                Tensor? pse_shift=None, Tensor? atten_mask=None,"
        "                                int[] actual_seq_lengths=[], int[] actual_seq_lengths_kv=[],"
        "                                Tensor? blocktable=None, int num_heads=1, float scale=1.0,"
        "                                int pre_tokens=2147483647, int next_tokens=2147483647,"
    ...
    ops.impl("npu_fused_infer_attention_score_get_workspace", torch::kPrivateUse1,
             &vllm_ascend::npu_fused_infer_attention_score_get_workspace);
}
#endif
